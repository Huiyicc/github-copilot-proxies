...
| [deepseek-ai/DeepSeek-V2.5](https://docs.siliconflow.cn/features/fim)                                                          | 付费      | `https://api.siliconflow.cn/v1/chat/completions`                     | 硅基流动官方支持的 FIM 补全模型         |
| [deepseek-ai/DeepSeek-Coder-V2-Instruct](https://docs.siliconflow.cn/features/fim)                                             | 付费      | `https://api.siliconflow.cn/v1/chat/completions`                     | 硅基流动官方支持的 FIM 补全模型         |
| [Qwen/Qwen2.5-Coder-7B-Instruct](https://docs.siliconflow.cn/features/fim)                                                     | 限免      | `https://api.siliconflow.cn/v1/chat/completions`                     | 硅基流动官方支持的 FIM 补全模型         |
